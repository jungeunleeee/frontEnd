...
gulp.task('deploy', function () {
    return gulp.src("./dist/**/*")
        .pipe(deploy({
            remoteUrl: "https://github.com/jungeunleeee/frontEnd.git",
            branch: "main"
        }))
})

gulp.task('default', gulp.series('html','ejs','scss:compile','js','images','svg','fonts', gulp.parallel('browserSync', 'watch')));

/* gulp.series 와 gulp.parallel 차이점 조사 */ 